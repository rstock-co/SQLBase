    ...
    <Box>
      ...
      <Container maxWidth="lg" sx={{ p: 6, pb: 2 }}>
        <Box className="section-title" sx={{
          ...
          <Typography variant='h4' color={theme.palette.black}>The Team</Typography></Box>
        ...
        <Box sx={{
          ...
          <Box className="subsection-content" sx={{
            ...
            <Image src="https://picsum.photos/200"
              height='350px' width='350px' />
            <Typography variant='h5' color={theme.palette.black} textAlign='center'>Business Owners</Typography>
            <br />
            <Typography className="section-text" color={theme.palette.black} textAlign='center'>Grow your business by finally tackling that tech project you've been dreaming of!  SQLBase allows users at any level of familiarity with SQL to start mapping out and converting their business logic into simple tables, or to improve the speed and efficiency of your developer team.  Visualize your project, and allow SQLBase to guide you through the database creation process.</Typography>
          </Box>
          <Box className="subsection-content" sx={{
            width: '350px',
            margin: 2,
